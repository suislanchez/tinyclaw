//! Example: Implementing a custom Memory backend for TinyClaw
//!
...
// ── Re-define the trait types (in your app, import from tinyclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 TinyClaw Memory Demo — InMemoryBackend\n");
