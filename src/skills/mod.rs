...
const OPEN_SKILLS_SYNC_MARKER: &str = ".tinyclaw-open-skills-sync";
const OPEN_SKILLS_SYNC_INTERVAL_SECS: u64 = 60 * 60 * 24 * 7;

/// A skill is a user-defined or community-built capability.
/// Skills live in `~/.tinyclaw/workspace/skills/<name>/SKILL.md`
    ...
    if !readme.exists() {
        std::fs::write(
            ...
            "# TinyClaw Skills\n\n\
             ...
             ```bash\n\
             tinyclaw skills install <github-url>\n\
    ...
    match command {
        crate::SkillCommands::List => {
            ...
            if skills.is_empty() {
                ...
                println!();
                println!("  Create one: mkdir -p ~/.tinyclaw/workspace/skills/my-skill");
                println!("              echo '# My Skill' > ~/.tinyclaw/workspace/skills/my-skill/SKILL.md");
                println!();
                println!("  Or install: tinyclaw skills install <github-url>");
            } else {
        ...
        crate::SkillCommands::Install { source } => {
            ...
            if source.starts_with("https://") || source.starts_with("http://") {
                ...
                if output.status.success() {
                    ...
                    println!("  Restart `tinyclaw channel start` to activate.");
                } else {
...
"#,
    ...
    #[test]
    fn skills_dir_path() {
        let base = std::path::Path::new("/home/user/.tinyclaw");
        let dir = skills_dir(base);
        assert_eq!(dir, PathBuf::from("/home/user/.tinyclaw/skills"));
    }
